...
customElements.define("init-welcome", class InitWelcome extends HTMLElement {
    ...
    addListeners() {
        ...
        const userNameEl = this.shadow.querySelector(".name");
        const selectRoomEl = this.shadow.querySelector(".select");
        const labelRoomEl = this.shadow.querySelector(".label-room");
        const choosedRoomEl = this.shadow.querySelector(".room-id");
        const buttonEl = this.shadow.querySelector(".form-btn");
